  ...
  return (
    <>
      <BrowserRouter>
        <AuthProvider>
          <Routes>
            <Route path='/' element={<ProtectedRoute rol={["client", "admin", "professional"]}><h1>index</h1></ProtectedRoute>}></Route>
            ...
            <Route path='/dashboard-admin' element={<ProtectedRoute rol={["admin"]}><DashboardLayout></DashboardLayout></ProtectedRoute>}>
              ...
              <Route path='solicitudes' element={<SolicitutesAdmin></SolicitutesAdmin>}></Route>
            </Route>
